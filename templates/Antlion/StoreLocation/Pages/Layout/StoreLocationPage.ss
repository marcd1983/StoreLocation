...
<% if $Content %>
  ...
  <% include Antlion/StoreLocation/Includes/GoogleMap %>
  <% include Antlion/StoreLocation/Includes/StoreSchedule %>
  <% include Antlion/StoreLocation/Includes/Departments %>
